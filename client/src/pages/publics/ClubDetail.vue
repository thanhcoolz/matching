<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div
        class="relative bg-white rounded-xl shadow-2xl overflow-hidden mb-12"
      >
        <img
          :src="club.main_image_url || 'https://placehold.co/1920x1080'"
          :alt="club.name"
      ...
      <div class="grid grid-cols-12 gap-12">
        ...
        <div class="col-span-12 lg:col-span-4 space-y-8">
          ...
          <!-- About -->
          <div
            class="bg-white rounded-xl shadow-lg p-8 transform hover:scale-[1.02] transition-transform duration-300"
          >
        ...
        <div class="col-span-12 lg:col-span-8">
          <div class="grid grid-cols-2 gap-6">
            <div
              v-for="(image, index) in club.sub_image_urls"
              :key="index"
...
const fetchClubDetails = async () => {
  try {
    const response = await apiClient.get(
      `/api/public/clubs/${route.params.id}`
    );
...
const createReservation = async () => {
  try {
    const startTime = new Date(
      `${reservation.value.date}T${reservation.value.hour}:${reservation.value.minute}:00`
    );

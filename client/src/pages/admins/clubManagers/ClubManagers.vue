  ...
  <div class="p-8 bg-gray-50 min-h-screen">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-8">
      <div class="flex justify-between items-center">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">Club Managers</h1>
          <p class="text-gray-500 mt-1">Manage access and permissions for club staff</p>
        </div>
        <button
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
      <div class="overflow-x-auto">
        <table class="w-full">
          <thead class="bg-gray-50">
            <tr>
              <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Manager Info
              </th>
              <th class="px-6 py-4 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider">Actions</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-200">
            <tr v-for="manager in managers" :key="manager.id" class="hover:bg-gray-50 transition-colors duration-200">
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                    <span class="text-blue-700 font-medium">{{ manager.username[0].toUpperCase() }}</span>
                  </div>
                  <div>
      ...
      <div v-if="managers.length === 0" class="text-center py-12">
        <div class="max-w-sm mx-auto">
          ...
          <p class="text-gray-500 mb-6">Add managers to help manage this club</p>
          <button
